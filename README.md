...
# PIE
PIE는 약 6주 (12월 14일 ~ 01월 22일)동안 준비한 비트캠프 2조(팀명: PIE)의 Spring FrameWork 중심의 파이널 프로젝트입니다. 아무것도 모르는 상태에서 5개월 간 프로그래밍을 배운 것을 총 활용해서 만든 프로젝트이며, 4명의 팀원이 함께 만들었습니다.
<br><br><br>
# 프로젝트 개요
